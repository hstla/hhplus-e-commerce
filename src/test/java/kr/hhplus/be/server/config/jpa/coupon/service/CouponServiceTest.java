...
class CouponServiceTest {
	...
	class UseUserCoupon {
		...
		void useFixedCouponSuccess() {
			...
			// when
			long discountedAmount = couponService.useUserCoupon(userCouponId, totalAmount, now);
		...
		void useCouponExpiredFail() {
			...
			// when then
			assertThatThrownBy(() -> couponService.useUserCoupon(userCouponId, totalAmount, now))
