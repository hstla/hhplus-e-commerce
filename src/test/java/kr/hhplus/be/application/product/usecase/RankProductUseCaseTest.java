...
class RankProductUseCaseTest extends IntegrationTestConfig {
	...
	class SuccessCases {
		...
		void getTop5Products_shouldAggregateAndCache() {
			...
			String todayKey = "hhplus:cache:ranking:product:sales:daily:" + LocalDate.now().minusDays(1).format(DateTimeFormatter.ofPattern("yy-MM-dd"));
			...
			String yesterdayKey = "hhplus:cache:ranking:product:sales:daily:" + LocalDate.now().minusDays(2).format(DateTimeFormatter.ofPattern("yy-MM-dd"));
			...
			String dayBeforeYesterdayKey = "hhplus:cache:ranking:product:sales:daily:" + LocalDate.now().minusDays(3).format(DateTimeFormatter.ofPattern("yy-MM-dd"));
