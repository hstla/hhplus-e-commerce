...
import kr.hhplus.be.server.config.jpa.coupon.domain.usercoupon.UserCoupon;
import kr.hhplus.be.server.config.jpa.coupon.domain.usercoupon.UserCouponRepository;
