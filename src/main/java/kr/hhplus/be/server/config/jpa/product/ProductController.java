...
public class ProductController implements ProductApiSpec {
	...
	public ResponseEntity<ProductDetailsResponse> getProductDetails(Long productId) {
		ProductOptionResponse productOption1 = new ProductOptionResponse("김풍", "보스", 2_000L, 50);
		ProductOptionResponse productOption2 = new ProductOptionResponse("빠니보틀", "행동대장", 1_000L, 100);
	...
	public ResponseEntity<List<ProductDetailsResponse>> getProductRank() {
		ProductOptionResponse productOption1 = new ProductOptionResponse("김풍", "보스", 2_000L, 50);
		ProductOptionResponse productOption2 = new ProductOptionResponse("빠니보틀", "행동대장", 1_000L, 100);
		ProductOptionResponse productOption3 = new ProductOptionResponse("곽준빈", "브레인", 1_000L, 100);
		ProductOptionResponse productOption4 = new ProductOptionResponse("키드밀리", "글로벌 마케터", 2_000L, 50);
