...
public interface UserApiSpec {
	...
	ResponseEntity<CommonResponse<UserResponse.User>> getUserDetails(
		@Parameter(description = "유저 아이디", required = true) @PathVariable @PositiveOrZero long userId);

	@Operation(summary = "유저 생성", description = "유저를 생성합니다.")
	ResponseEntity<CommonResponse<UserResponse.User>> createUser(
	...
	ResponseEntity<CommonResponse<UserResponse.User>> updateUser(
		@Parameter(description = "유저 아이디", required = true) @PathVariable @PositiveOrZero long userId,
